...
static int __init mipi_cmd_sony_hd_init(void)
{
	...
	pinfo.lcd.v_back_porch = 1;//0;//4;// 20130110 shkwak, to prevent tearing in upper side
	pinfo.lcd.v_front_porch = 1;//10;
	pinfo.lcd.v_pulse_width = 2;//4;// shkwak 20121123, v_pulse test value for tearing
	...
	pinfo.lcd.refx100 = 6700;//6500 /* adjust refx100 to prevent tearing */
